...
### T007 [P] Create CompletedTasksInputSchema with time window refinements
...
### T008 Implement getCompletedTasksByCompletionDate in TodoistApiService
...
**Validation**: Method implemented, some contract tests (T002) now pass
**Details**:
...
### T009 Implement getCompletedTasksByDueDate in TodoistApiService
**File**: `src/services/todoist-api.ts`
...
**Validation**: Method implemented, some contract tests (T003) now pass
**Details**:
...
### T010 Add list_completed case to TodoistTasksTool.execute()
...
### T011 Implement handleListCompleted() method in TodoistTasksTool
**File**: `src/tools/todoist-tasks.ts`
...
### T012 Update todoist_tasks tool definition with list_completed action
**File**: `src/tools/todoist-tasks.ts`
...
### T013 [P] Update CHANGELOG.md and README.md with completed tasks feature
...
### T014 Run quality gates and verify all tests pass
...
### T015 Execute quickstart validation checklist
